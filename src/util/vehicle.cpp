...
namespace big::vehicle
{
	...
	bool remote_control_vehicle(Vehicle veh)
	{
		...
		if (settings::g_m_remote_controlled_vehicle == veh)
		{
			return false;
		}
		...
		settings::g_m_remote_controller_vehicle = spawned;
		settings::g_m_remote_controlled_vehicle = veh;
		return true;
	}
